...
if os.path.exists('VGGre16-CIFAR100.pkl'):
    print("Loaded VGGre16-CIFAR100.pkl")
    pkl = torch.load('VGGre16-CIFAR100.pkl')
...
while (scheduler.last_epoch < 1000):
    ...
    torch.save(
        ...
        'VGGre16-CIFAR100-(%03d,%.04f,%.04f).pkl' %(scheduler.last_epoch, trainAccuracy, testAccuracy)
        )
